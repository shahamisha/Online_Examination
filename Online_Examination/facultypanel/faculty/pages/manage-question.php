                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    ...
                                                    $selCourse = $conn->query("SELECT * FROM sub_master WHERE s_id='$courseId' ");
                                                    while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) {
                                                        echo $selCourseRow['name'];
                                                    }
                                                ?>
                                            </td>
                                            ...
                                            <td class="text-center">
                                             <a href="manage-question.php?id=<?php echo $selExamRow['ex_id']; ?>" type="button" class="btn btn-primary btn-sm">Manage</a>
