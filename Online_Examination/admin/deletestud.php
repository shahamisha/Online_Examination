  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <!-- <a class="collapse-item" href="login.php">Login</a>-->
             <a class="collapse-item" href="viewsub.php">All Sub</a>
      ...
      <!--      <div class="collapse-divider"></div>
            ...
            <a class="collapse-item" href="#">STUDENTWISE EXAM</a>
		...
		<li class="nav-item">
			<a class="nav-link collapsed" href="logout.php" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
			<i class="fas fa-fw fa-cog"></i>
				<span>LOGOUT</span>
			</a>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">    
				...
				?>
				<script>
				window.location.href='http://localhost/Online_Examination/admin/viewstud.php';
				</script>
				<?php				
