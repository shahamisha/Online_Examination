				...
				?>
					<table class='table table-hover table-striped'>
						...
						<?php
							include ('conn.php');
							$id=$_GET['s_id'];
							$selCourse = $conn->query("SELECT * FROM students WHERE id='$id' ")->fetch(PDO::FETCH_ASSOC);	//	$cmd=mysql_query($sql,$con) or die(mysql_error());						
						...
						?>
							...
							<tr>
								<td>Student name:</td>
								<td><input type="text" name="txtname" value="<?php echo $selCourse['name'];?>" class="form-control"/></td>
							</tr>
							<br>
							<tr>
								<td>Email:</td>
