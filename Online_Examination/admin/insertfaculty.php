    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h3 class="h3">Insert Faculty Data</h3>
        ...
        <div class="container-fluid h-100">
          ...
          <div class="row no-gutters">
			  <div class="table-responsive">
				...
				?>
						<!--<h3>Record successfully inserted</h3>-->
				...
				?>
					<table class='table table-hover table-striped'>
						<tbody>
							...
							<tr>
								<td>Subject:</td>
								<td><input type="text" name="txtsub" class="form-control"/></td>
							</tr>
							<br>
							<tr>
									<td>
										<button type="submit" name="btnsubmit" class="btn btn-outline-dark">SUBMIT
										</button>
									</td>
								</tr>
						</tbody>
				...
				<?php
					...
					{ 
						...
						$insCourse = $conn->query("INSERT INTO faculty_master(fname,email,password,main_subject) VALUES('$name','$email','$encrypted_pwd','$sub') "); 
						@mysqli_close($conn);
					}
					?>
